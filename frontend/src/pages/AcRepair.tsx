...
const AcRepair = () => {
  ...
  return (
    <ServiceDetail
      service={service}
      seoTitle="AC Repair in Delhi | Same-Day Service | FastFixx Services"
      ...
      detail="At FastFixx Services, we repair every type of air conditioner — split, window, cassette and inverter ACs — from all major brands. Our team carries genuine spare parts and uses calibrated tools for accurate gas charging and leak detection. Every AC repair in Delhi includes a free general checkup, transparent pricing and a 30-day warranty so you can book with confidence."
    />
  );
};
