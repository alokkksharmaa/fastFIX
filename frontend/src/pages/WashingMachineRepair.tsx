...
const WashingMachineRepair = () => {
  ...
  return (
    <ServiceDetail
      service={service}
      seoTitle="Washing Machine Repair in Delhi | FixFast Services"
      ...
      detail="Whether you have a top-load, front-load or semi-automatic washing machine, FixFast technicians diagnose the root cause quickly and use genuine spare parts for a long-lasting fix. We handle motor replacements, PCB faults, drain pump issues, error codes and full machine servicing — all backed by a 30-day warranty and clear, upfront pricing."
    />
  );
};
