...
const MicrowaveRepair = () => {
  ...
  return (
    <ServiceDetail
      service={service}
      seoTitle="Microwave Repair Service in Delhi | FixFast Services"
      ...
      intro="A microwave that won't heat or sparks during use needs urgent attention. FixFast offers safe, affordable microwave repair in Delhi for every model and brand."
