...
const RefrigeratorRepair = () => {
  ...
  return (
    <ServiceDetail
      service={service}
      seoTitle="Refrigerator Repair Service in Delhi | FastFixx Services"
      ...
      detail="FastFixx Services handles every type of refrigerator — single door, double door, side-by-side and convertible models — from leading brands. From compressor faults to thermostat replacements and gas charging, our trained technicians arrive with the right tools and original spare parts. Each refrigerator repair includes a free safety check and a 30-day service warranty."
    />
  );
};
